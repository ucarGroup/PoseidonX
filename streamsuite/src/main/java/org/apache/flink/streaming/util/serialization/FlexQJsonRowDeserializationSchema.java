 ...
 */
public class FlexQJsonRowDeserializationSchema implements DeserializationSchema<Row> {
     ...
     * @param columnNames
     */
    public FlexQJsonRowDeserializationSchema(TypeInformation<Row> typeInfo, String[] columnNames) {
