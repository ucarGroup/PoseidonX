...
import com.huawei.streaming.cql.semanticanalyzer.parser.context.RelationExpressionContext;
...
public class RelationExpressionVisitor extends AbsCQLParserBaseVisitor<RelationExpressionContext>
{
     ...
     */
    @Override
    public RelationExpressionContext visitRelationOperator(@NotNull CQLParser.RelationOperatorContext ctx)
    {
     ...
     */
    @Override
    public RelationExpressionContext visitBitExpression(@NotNull CQLParser.BitExpressionContext ctx)
    {
