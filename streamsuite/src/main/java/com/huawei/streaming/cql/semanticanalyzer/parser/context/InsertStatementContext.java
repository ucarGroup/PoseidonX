...
import com.huawei.streaming.cql.semanticanalyzer.InsertStatementAnalyzer;
...
public class InsertStatementContext extends ParseContext
{
    ...
    {
        return "INSERT INTO STREAM " + streamName + " " + select.toString();
    }
    ...
    {
        return new InsertStatementAnalyzer(this);
    }
