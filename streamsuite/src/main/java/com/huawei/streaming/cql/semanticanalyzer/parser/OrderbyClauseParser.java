...
import com.huawei.streaming.cql.semanticanalyzer.parser.visitor.OrderbyClauseVisitor;

/**
 * 解析完整的CQL语句
 * 
 */
public class OrderbyClauseParser implements IParser
{
    private static final Logger LOG = LoggerFactory.getLogger(OrderbyClauseParser.class);
