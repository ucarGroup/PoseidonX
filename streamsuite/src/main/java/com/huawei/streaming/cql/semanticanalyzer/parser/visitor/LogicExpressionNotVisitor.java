...
import com.huawei.streaming.cql.semanticanalyzer.parser.context.LogicExpressionNotContext;
...
public class LogicExpressionNotVisitor extends AbsCQLParserBaseVisitor<LogicExpressionNotContext>
{
     ...
     */
    @Override
    public LogicExpressionNotContext visitIdentifierNot(@NotNull CQLParser.IdentifierNotContext ctx)
    {
        context.setNot(true);
        return context;
    }
     ...
     */
    @Override
    public LogicExpressionNotContext visitEqualRelationExpression(@NotNull CQLParser.EqualRelationExpressionContext ctx)
    {
