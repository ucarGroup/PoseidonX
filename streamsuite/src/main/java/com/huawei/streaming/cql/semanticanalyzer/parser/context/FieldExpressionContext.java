...
public class FieldExpressionContext extends BaseExpressionParseContext
{
    ...
    {
        return streamNameOrAlias == null ? atomExpression.toString() : streamNameOrAlias + "."
    ...
    {
        walkExpression(walker, atomExpression);
    }
    ...
    {
        if (replacer.isChildsReplaceable(atomExpression))
        {
            atomExpression = replacer.createReplaceParseContext();
        }
        else
        {
            atomExpression.walkChildAndReplace(replacer);
        }
