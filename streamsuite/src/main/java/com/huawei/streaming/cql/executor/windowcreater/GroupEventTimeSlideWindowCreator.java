 ...
 * 
 */
public class GroupEventTimeSlideWindowCreator implements WindowCreator
{
    ...
    {
        IExpression[] timestampExpressions =
        ...
        return new GroupEventTimeSlideWindow(groupbyExpressions, window.getLength(), timestampExpressions[0]);
    }
