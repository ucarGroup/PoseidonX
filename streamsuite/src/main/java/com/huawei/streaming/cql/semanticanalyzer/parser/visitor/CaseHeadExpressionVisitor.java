...
import com.huawei.streaming.cql.semanticanalyzer.parser.context.CaseHeadExpressionContext;
...
public class CaseHeadExpressionVisitor extends AbsCQLParserBaseVisitor<CaseHeadExpressionContext>
{
     ...
     */
    @Override
    public CaseHeadExpressionContext visitExpression(@NotNull CQLParser.ExpressionContext ctx)
    {
