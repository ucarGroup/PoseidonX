 ...
 * 
 */
public class SelectItemContext extends ParseContext
{
    private SelectExpressionContext expression;
    ...
    public SelectExpressionContext getExpression()
    {
        return expression;
    }
    
    public void setExpression(SelectExpressionContext expression)
    {
