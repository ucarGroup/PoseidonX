...
public class OutputSchemaVisitor extends AbsCQLParserBaseVisitor<OutputSchemaStatementContext>
{
    ...
    private OutputSchemaStatementContext context;
    
    /**
     * 输出schema遍历
     */
    public OutputSchemaVisitor()
    {
        context = new OutputSchemaStatementContext();
    }
     ...
     */
    @Override
    protected OutputSchemaStatementContext defaultResult()
    {
        return context;
    }
     ...
     */
    @Override
    public OutputSchemaStatementContext visitColumnNameTypeList(@NotNull CQLParser.ColumnNameTypeListContext ctx)
    {
