...
{
    private GetStatementContext context = null;
    ...
    {
        context = new GetStatementContext();
    }
     ...
     */
    @Override
    protected GetStatementContext defaultResult()
    {
        return context;
    }
     ...
     */
    @Override
    public GetStatementContext visitConfName(@NotNull CQLParser.ConfNameContext ctx)
    {
