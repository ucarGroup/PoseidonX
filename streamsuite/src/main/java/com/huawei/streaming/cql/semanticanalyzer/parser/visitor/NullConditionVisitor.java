...
import com.huawei.streaming.cql.semanticanalyzer.parser.context.NullConditionContext;
...
public class NullConditionVisitor extends AbsCQLParserBaseVisitor<NullConditionContext>
{
     ...
     */
    @Override
    public NullConditionContext visitIdentifierNot(@NotNull CQLParser.IdentifierNotContext ctx)
    {
        context.setNot(true);
        return context;
    }
