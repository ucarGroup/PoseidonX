 ...
 * 
 */
public class ColumnNameOrderContext extends ParseContext
{
    private ExpressionContext expression;
    
    private SortEnum orderType = SortEnum.ASC;
    ...
    {
        return expression.toString() + " " + orderType.getDesc();
    }
    ...
    public SortEnum getOrderType()
    {
        return orderType;
    }
    
    public void setOrderType(SortEnum orderType)
    {
