...
public class ColumnNameOrderVisitor extends AbsCQLParserBaseVisitor<ColumnNameOrderContext>
{
     ...
     */
    @Override
    public ColumnNameOrderContext visitExpression(@NotNull CQLParser.ExpressionContext ctx)
    {
     ...
     */
    @Override
    public ColumnNameOrderContext visitColumnOrder(@NotNull CQLParser.ColumnOrderContext ctx)
    {
        context.setOrderType(SortEnum.valueOf(ctx.getText().toUpperCase(Locale.US)));
        return context;
    }
