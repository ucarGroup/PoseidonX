...
public class FilterBeforeWindowVisitor extends AbsCQLParserBaseVisitor<FilterBeforeWindowContext>
{
    ...
    {
        context = new FilterBeforeWindowContext();
    }
     ...
     */
    @Override
    protected FilterBeforeWindowContext defaultResult()
    {
        return context;
    }
     ...
     */
    @Override
    public FilterBeforeWindowContext visitExpression(@NotNull CQLParser.ExpressionContext ctx)
    {
