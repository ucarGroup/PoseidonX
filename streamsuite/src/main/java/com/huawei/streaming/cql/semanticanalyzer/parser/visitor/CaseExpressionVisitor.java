...
import com.huawei.streaming.cql.semanticanalyzer.parser.context.CaseExpressionContext;
...
public class CaseExpressionVisitor extends AbsCQLParserBaseVisitor<CaseExpressionContext>
{
     ...
     */
    @Override
    public CaseExpressionContext visitCaseHeadExpression(@NotNull CQLParser.CaseHeadExpressionContext ctx)
    {
     ...
     */
    @Override
    public CaseExpressionContext visitCaseWhenBodyWhenBody(@NotNull CQLParser.CaseWhenBodyWhenBodyContext ctx)
    {
     ...
     */
    @Override
    public CaseExpressionContext visitCaseWhenBodyThenBody(@NotNull CQLParser.CaseWhenBodyThenBodyContext ctx)
    {
     ...
     */
    @Override
    public CaseExpressionContext visitCaseWhenElse(@NotNull CQLParser.CaseWhenElseContext ctx)
    {
