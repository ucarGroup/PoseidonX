 ...
 * 输入schema
 */
public class InputSchemaStatementContext extends ParseContext
{

    /**
     * 输入schema
     */
    private ColumnNameTypeListContext inputSchema;
    
    public ColumnNameTypeListContext getInputSchema()
    {
        return inputSchema;
    }

    public void setInputSchema(ColumnNameTypeListContext inputSchema)
    {
    ...
    {
        return " INPUT " + inputSchema.toString();
    }
