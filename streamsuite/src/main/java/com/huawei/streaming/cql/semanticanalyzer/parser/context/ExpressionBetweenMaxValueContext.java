...
/**
 * between表达式maxvalue解析内容
 * 
 */
public class ExpressionBetweenMaxValueContext extends BaseExpressionParseContext
{
    ...
    public void setExpression(BitExpressionContext expression)
    {
