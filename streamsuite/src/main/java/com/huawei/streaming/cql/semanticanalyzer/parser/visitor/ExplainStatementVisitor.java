...
{
    private ExplainStatementContext context = null;
    ...
    {
        context = new ExplainStatementContext();
    }
     ...
     */
    @Override
    protected ExplainStatementContext defaultResult()
    {
        return context;
    }
     ...
     */
    @Override
    public ExplainStatementContext visitApplicationName(@NotNull CQLParser.ApplicationNameContext ctx)
    {
     ...
     */
    @Override
    public ExplainStatementContext visitPath(@NotNull CQLParser.PathContext ctx)
    {
