 ...
 * 
 */
public class CreateDatasourceAnalyzehook implements SemanticAnalyzeHook
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        return parseContext instanceof CreateDataSourceContext;
    }
    ...
    {
        CreateDataSourceAnalyzeContext csContext = (CreateDataSourceAnalyzeContext)analyzeConext;
        DriverContext.getBuilderNameSpace().get().addDataSourceDefined(csContext);
    }
