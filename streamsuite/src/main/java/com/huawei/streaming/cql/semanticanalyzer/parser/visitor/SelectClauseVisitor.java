...
public class SelectClauseVisitor extends AbsCQLParserBaseVisitor<SelectClauseContext>
{
     ...
     */
    @Override
    public SelectClauseContext visitDistinct(@NotNull CQLParser.DistinctContext ctx)
    {
     ...
     */
    @Override
    public SelectClauseContext visitSelectItem(@NotNull CQLParser.SelectItemContext ctx)
    {
