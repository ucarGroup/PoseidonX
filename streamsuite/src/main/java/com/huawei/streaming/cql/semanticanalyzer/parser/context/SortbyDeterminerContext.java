 ...
 * 
 */
public class SortbyDeterminerContext extends ParseContext
{
    
    private ExpressionContext expression = null;
    
    /**
     * <默认构造函数>
     */
    public SortbyDeterminerContext()
    {
    ...
    {
        return expression == null ? "" : "SORT BY " + expression.toString();
    }
