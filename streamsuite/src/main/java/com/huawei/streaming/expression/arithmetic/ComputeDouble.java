 ...
 * 
 */
public class ComputeDouble implements ICompute
{
    
    /**
     * 序列化ID
     */
    private static final long serialVersionUID = 4223321604321025859L;
    
    /**
     * 日志打印对象
     */
    private static final Logger LOG = LoggerFactory.getLogger(ComputeDouble.class);
