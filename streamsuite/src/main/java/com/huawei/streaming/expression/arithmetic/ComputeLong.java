 ...
 * 
 */
public class ComputeLong implements ICompute
{
    
    /**
     * 序列化ID
     */
    private static final long serialVersionUID = -5195979811721443807L;
    
    /**
     * 日志打印对象
     */
    private static final Logger LOG = LoggerFactory.getLogger(ComputeLong.class);
